...
typeof document < "u" && typeof window < "u" && (me ? (document.addEventListener("touchstart", ae, w ? {
  passive: !0,
  capture: !0
...
const L = /* @__PURE__ */ k($t, [["render", wt]]), we = {
  ...L,
  name: "VDropdown",
...
const ye = /* @__PURE__ */ k(_t, [["render", Pt]]), Pe = "v-popper--has-tooltip";
function Tt(e, t) {
  let o = e.placement;
  if (!o && t)
    for (const i of ge)
...
function le(e) {
  e.addEventListener("click", Se), e.addEventListener("touchstart", ze, w ? {
    passive: !0
  } : !1);
}
function ue(e) {
...
}, Ot = u, Mt = Ce, kt = He, Et = we, Lt = _e, Bt = K, Dt = Q, It = Z, Rt = L, Ft = J, Vt = ve, jt = ye;
function zt(e, t = {}) {
  e.$_vTooltipInstalled || (e.$_vTooltipInstalled = !0, fe(u, t), e.directive("tooltip", Ce), e.directive("close-popper", He), e.component("VTooltip", ve), e.component("VDropdown", we), e.component("VMenu", _e));
}
const xt = {
